...
prob_boy_if_identical = 1
prob_boy_if_fraternal = prob_boy*prob_fraternal
prob_boy_twin = prob_identical*prob_boy_if_identical+prob_boy_if_fraternal

probability = prob_identical*prob_boy_if_identical / prob_boy_twin

print(probability)
```
```
probability = 0.45 repeating, of course.
```
---
...
>> If my undestanding is correct bayesians treat any given probability/sample as belonging to some known, previously determined distribution whereas frequentists treat any given probability/sample as having its own, unique distribution.
